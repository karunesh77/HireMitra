...
export default function EmployerRegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (formData.website && !validateURL(formData.website).valid) {
        allErrors.website = 'Invalid URL';
      }
      ...
      // Auto-login successful, redirect to employer dashboard
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#001F3F] to-[#003366] flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#B0C4DE] text-sm">Employer Registration</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-10">
          ...
          <p className="text-[#4A4A4A] mb-8">
            Find skilled workers and complete your projects efficiently
          </p>
            ...
            <div className="pt-4 border-t border-[#E5E7EB]">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <TextArea
                    placeholder="Tell workers about your company and what kind of work you do..."
                    name="description"
        ...
        <div className="mt-8 text-center text-[#B0C4DE] text-xs">
          <p>
            Complete your profile after registration to start posting jobs and hiring
            workers
          </p>
        </div>
      </div>
